...
//
//import de.ruf2.rube.sunshine.app.data.TestDb_old;
...
//
//         ContentValues testValues = TestDb_old.createNorthPoleLocationValues();
//
...
//         );
//
//         TestDb_old.validateCursor(cursor, testValues);
//
...
//         ContentValues weatherValues = TestDb_old.createWeatherValues(locationRowId);
//
...
//         );
//
//         TestDb_old.validateCursor(weatherCursor, weatherValues);
//
...
//                 WeatherEntry.buildWeatherLocation(TestDb_old.TEST_LOCATION),
//                 null, // leaving "columns" null just returns all the columns.
//                 null, // cols for "where" clause
//                 null, // values for "where" clause
//                 null  // sort order
...
//                         TestDb_old.TEST_LOCATION, TestDb_old.TEST_DATE),
//                 null, // leaving "columns" null just returns all the columns.
//                 null, // cols for "where" clause
//                 null, // values for "where" clause
//                 null  // sort order
...
//         weatherCursor = mContext.getContentResolver().query(
//                 WeatherEntry.buildWeatherLocationWithDate(TestDb_old.TEST_LOCATION, TestDb_old.TEST_DATE),
//                 null,
//                 null,
//                 null,
//                 null
...
//         ContentValues values = TestDb_old.createNorthPoleLocationValues();
//
...
//         );
//
//         TestDb_old.validateCursor(cursor, updatedValues);
//     }
//
